...
export const drinks: Drink[] = [
    ...
    {
        img: 'https://pcth.s3-ap-southeast-1.amazonaws.com/default.jpg',
        materials: ['Kem sô cô la 2 viên', 'Sữa đặc 20ml', 'Sốt sô cô la 20ml', 'Sữa tươi 50ml'],
        steps: ['Cho 1 viên kèm cùng các thành phần còn lại vào xay'
            , 'Cho vào ly', 'Xịt kem', 'Cho viên kem còn lại lên giữa'],
        type: 'Milk Shaker',
    ...
    },
    {
        ...
        type: 'Milk Shaker',
        name: 'Strawberry Milk Shaker (Dâu)',
    },
    // Mojito
    {
